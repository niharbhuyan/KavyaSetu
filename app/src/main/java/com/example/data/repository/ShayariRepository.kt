...
class ShayariRepository(
    ...
    private fun getCuratedSeedShayaris(): List<Shayari> {
        ...
        return listOf(
            ...
            Shayari(
                id = "sh_hi_nazm_faiz",
                lines = "बोल कि लब आज़ाद हैं तेरे\nबोल ज़बाँ अब तक तेरी है\nतेरा सुतवाँ जिस्म है तेरा\nबोल कि जाँ अब तक तेरी है\n\nदेख कि शीशगर की दूकां में\nतुंद हैं शो'ले सुर्ख़ है आहिन\nखुलने लगे क़ुफ़्लों के दहाने\nफैला हर एक ज़ंजीर का दामन",
                author = "Faiz Ahmad Faiz",
                penName = "Faiz",
                language = "hindi",
                emotion = "hausla",
                category = "inspiration",
                tags = "nazm, long poem, resistance, faiz, voice, freedom, courage",
                likesCount = 680,
                isSaved = true,
                isDownloaded = true,
                timestamp = now - 500000,
                translationEnglish = "Speak, for your lips are yet free; speak, for your tongue is still your own; your upright body is still yours; speak, for your life is still your own.\nSee how in the blacksmith's forge, flames flare red and iron burns fierce; the mouths of padlocks are beginning to open, and every chain is beginning to widen its embrace.",
                translationOdia = "କୁହ ଯେ ତୁମ ଓଠ ଆଜି ବି ମୁକ୍ତ, କୁହ ଯେ ତୁମ କଣ୍ଠ ତୁମର ଅଟେ। ଲୁହା ଜଳୁଛି ନିଆଁର ଉତ୍ତାପରେ, ଶିକୁଳି ଭାଙ୍ଗିବାର ସମୟ ଆସିଛି।",
                poeticAnalysis = "Legendary revolutionary Nazm in classical meter, inspiring fearless truth, freedom of expression and fortitude.",
                isTrending = true
            ),
            Shayari(
                id = "sh_hi_ghazal_iqbal",
                lines = "ख़ुदी को कर बुलंद इतना कि हर तक़दीर से पहले\nख़ुदा बंदे से ख़ुद पूछे बता तेरी रज़ा क्या है\n\nसितारों से आगे जहाँ और भी हैं\nअभी इश्क़ के इम्तिहाँ और भी हैं\n\nतू शाहीं है परवाज़ है काम तेरा\nतेरे सामने आसमाँ और भी हैं",
                author = "Allama Iqbal",
                penName = "Iqbal",
                language = "hindi",
                emotion = "hausla",
                category = "philosophy",
                tags = "ghazal, long poem, khudi, iqbal, destiny, eagle, stars, ambition",
                likesCount = 740,
                isSaved = true,
                isDownloaded = true,
                timestamp = now - 600000,
                translationEnglish = "Elevate your selfhood to such heights that before decreeing your destiny, God Himself shall ask: 'Tell me, what is your desire?'\nBeyond the stars there are worlds yet to explore; there are still further trials of love awaiting you.\nYou are an eagle, flight is your true vocation; there are skies beyond skies spread before you.",
                translationOdia = "ନିଜର ଆତ୍ମବିଶ୍ୱାସକୁ ଏତେ ଉଚ୍ଚ କର ଯେ ବିଧାତା ନିଜେ ତୁମ ଇଚ୍ଛା ପଚାରିବେ। ତାରାମାନଙ୍କ ଆଗରେ ଅନନ୍ତ ଆକାଶ ବାକି ଅଛି।",
                poeticAnalysis = "Philosophical masterpiece celebrating human agency, limitless spiritual potential, and purposeful ascension.",
                isTrending = true
            ),
            Shayari(
                id = "sh_hi_2",
